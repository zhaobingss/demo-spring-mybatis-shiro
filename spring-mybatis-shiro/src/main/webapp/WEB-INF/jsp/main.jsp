...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="static/third/assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/forms/styling/uniform.min.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/pickers/daterangepicker.js"></script>
	<script type="text/javascript" src="static/third/assets/js/plugins/ui/nicescroll.min.js"></script>

	<script type="text/javascript" src="static/third/assets/js/core/app.js"></script>
	<script type="text/javascript" src="static/third/assets/js/pages/dashboard.js"></script>
	<script type="text/javascript" src="static/third/assets/js/pages/layout_fixed_custom.js"></script>
	<!-- /theme JS files -->
